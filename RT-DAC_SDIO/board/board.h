...
#define BOARD_NAME                  "Chinkstuff Enterprises STM32F407VET6 board"
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_OTG_FS_DP))
...
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_OPENDRAIN(GPIOC_SDD0) |       \
                                     PIN_OTYPE_OPENDRAIN(GPIOC_SDD1) |       \
                                     PIN_OTYPE_OPENDRAIN(GPIOC_SDD2) |       \
                                     PIN_OTYPE_OPENDRAIN(GPIOC_SDD3) |      \
                                     PIN_OTYPE_OPENDRAIN(GPIOC_SDCLK))
...
#define VAL_GPIOD_OTYPER            (PIN_OTYPE_OPENDRAIN(GPIOD_SDCMD))
